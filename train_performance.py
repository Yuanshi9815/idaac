...
def train(args):
    ...
    for j in range(num_updates):
        ...
        for step in range(args.num_steps):
            contexts_infos = [json.dumps(context) for context in envs.get_context()]
            # Sample actions
            with torch.no_grad():
            ...
            #         envs.venv.venv.venv.venv.env.set_context_to(
            #             idx, context_decoder(random_context))
        ...
        # loss_quantity_all = aloss_quantity_all + \
        #     vloss_quantity_all * args.value_loss_coef
        ...
        # show_in_terminal(
        #     log_cur_update, settings[args.env_name]["context_shape"])
